window.ORIKI_AUTO_INTELLIGENCE = [
  ...
  {
    "id": "auto-016c3ec9b775",
    "name": "CHATGPT FOR FINANCIAL SERVICES",
    "provider": "OpenAI",
    "type": "AI Platform",
    "category": "Auto-detected",
    "capabilities": [],
    "purposes": [],
    "description": "Introducing ChatGPT for Financial Services, combining built-in financial data and GPT-6 Astra for research, modeling, and client-ready materials.",
  ...
  },
  {
    ...
    "capabilities": [],
    "purposes": [],
    "description": "Build and launch cloud agents with the Agents API, a managed service powered by the Codex harness for orchestration, long-running sessions, and tool use.",
  ...
  },
  {
    ...
    "capabilities": [],
    "purposes": [],
    "description": "Introducing Gemini 3.8 Live and 3.8 Live Extended Thinking",
    ...
    "detectedDate": "2026-09-19",
    "slug": "gemini-3-8-live-and-3-8-live-extended-thinking"
  },
  {
